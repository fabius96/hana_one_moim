    ...
    <div class="main-container">
        ...
        <div class="content-wrapper">
            <div class="header-container">
                ...
                <a href="${pageContext.request.contextPath}/account/account-info-hana" class="unchosen-page">하나은행</a>
                <a href="${pageContext.request.contextPath}/account/account-info-other" class="chosen-page">다른은행</a>
            </div>
